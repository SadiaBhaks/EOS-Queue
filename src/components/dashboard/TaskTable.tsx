      ...
      <div ref={tableRef} className="overflow-y-auto flex-1">
        {filtered.length === 0 ? (
          ...
          <table className="w-full">
            ...
            <tbody>
              {filtered.map((task) => (
                // ── key moves to React.Fragment — fixes the warning ──────────
                <React.Fragment key={task.task_id}>
                  ...
                  >
                    <td className="px-5 py-3">
                      ...
                      <div className="font-mono text-xs text-text-muted mt-0.5 truncate max-w-[180px]">
                        {task.task_id}
                      </div>
                    </td>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-10 h-1 bg-bg-elevated rounded-full overflow-hidden">
                          <div
                            ...
                            style={{ width: `${(task.priority_level / 5) * 100}%` }}
                          />
                        </div>
