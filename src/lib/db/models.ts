...
import type { Task, IdempotencyRecord, DLQEntry } from "@/types";
...
export const TaskModel =
  (models.Task as mongoose.Model<TaskDocument>) ||
...
export const DLQModel =
  (models.DLQ as mongoose.Model<DLQDocument>) ||
  model<DLQDocument>("DLQ", DLQSchema);

export const WorkerModel =
  (models.Worker as mongoose.Model<WorkerDocument>) ||
